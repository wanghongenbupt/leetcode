...
public class P_558 {
    ...
    * 任何节点 与 值为true的叶子节点 或为 true的叶子节点
    * 任何节点 与 值为false的叶子节点 或为 任何节点
     * */
    public Node intersect(Node q1, Node q2) {
        ...
        if (q1.topLeft.isLeaf && q1.topRight.isLeaf
                && q1.bottomLeft.isLeaf
                && q1.bottomRight.isLeaf &&
                q1.topRight.val == q1.topLeft.val &&
                q1.bottomLeft.val == q1.topLeft.val &&
                q1.bottomRight.val == q1.topLeft.val) {
                q1.isLeaf = true;
